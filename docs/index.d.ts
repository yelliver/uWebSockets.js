 ...
 */
export interface WebSocket<UserData = any> {
...
export interface WebSocketBehavior<UserData = any> {
...
export interface TemplatedApp<UserData> {
    ...
    ws(pattern: RecognizedString, behavior: WebSocketBehavior<UserData>) : TemplatedApp;
